...
if user_choice == 1:
    ...
    price_product_1 = driver.find_element(By.XPATH, f"(//div[@class='inventory_item_price'])[{user_choice}]")
    ...
    cart_price_product_1 = (driver.find_element
                            (By.XPATH, f"(//div[@class='inventory_item_price'])[1]"))
    ...
    price_product_2 = driver.find_element(By.XPATH, f"(//div[@class='inventory_item_price'])[{user_choice}]")
    ...
    price_product_3 = driver.find_element(By.XPATH, f"(//div[@class='inventory_item_price'])[{user_choice}]")
    ...
    price_product_4 = driver.find_element(By.XPATH, f"(//div[@class='inventory_item_price'])[{user_choice}]")
    ...
    price_product_5 = driver.find_element(By.XPATH, f"(//div[@class='inventory_item_price'])[{user_choice}]")
    ...
    price_product_6 = driver.find_element(By.XPATH, f"(//div[@class='inventory_item_price'])[{user_choice}]")
